🛡️ Kali Linux Virtual Machine Setup
📌 Project Overview
...
ip a
ping google.com
8️⃣ Install / Verify Nmap

Checked the Nmap installation and used it as part of the initial cybersecurity learning environment.

nmap --version
9️⃣ Basic Linux Practice

Practiced basic Linux commands and explored the Kali Linux environment to become familiar with the operating system.

📸 Screenshots

Screenshots of the VirtualBox configuration, Kali Linux environment, network configuration, connectivity tests, and Nmap verification are included as part of the project documentation.
